...
<body style="background-color:#FAECE7">
    <div style="background-color:#FAECE7"> 
        <button class="btnFormLogIn" id="Button1" onclick="Button1_Click">Log In</button>
        <form id="form1" runat="server">
                <div class="ContAmarillo">
                    <div class="container text-center">
                        <h1 class="titulo">Bienvenid@</h1>
                        <h2 class="titulo">¿Listo para entrenar?</h2>
                        <input type="text" class="form-control form-control-lg mt-4" placeholder="Ingresa tu dni">
                        <input class="btnForm" type="submit" value="A entrenar!" runat="server" onserverclick="Ingresar"/>
                    </div>
                </div>
            </form>
    </div>
